...
import algorithms.published.LockFreePBSTMap;
 ...
 * @author elias-pap
 */
public class LockFreePBSTAdapter<K extends Comparable<? super K>> extends AbstractAdapter<K> implements SetInterface<K> {
    LockFreePBSTMap<K,K> tree = new LockFreePBSTMap<K,K>();
